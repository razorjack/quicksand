...
Added support of translate3d for animation.

This fork was created to allow for re-use of visible elements rather than replacing them with the new incoming elements (via AJAX).
